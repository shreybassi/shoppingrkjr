...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['productImage2']);?>"  width="200" height="334" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Rs. <?php echo htmlentities($rws['productPrice']);?>
								</span>
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" />
                </a>
            </div><!-- /.single-product-gallery-item -->
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div class="item">
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage2']);?>"/>
                    </a>
                </div>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['productAvailability']." ".$row['unit']);?> </span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['gst']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
...
<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Minimum Order Quantity :<span class="value"style="color:red">&nbsp<?php echo htmlentities($row['MinOrdQty']);?></span></span> 
										</div>	
									</div>
								...
								<div class="row">
									...
									<b>&nbsp &nbsp The Minimum Order Quantity that is specified would be considered if Quantity<br> &nbsp &nbsp mentioned is less than Minimum Order quantity in your final bill.<br>
										&nbsp &nbsp Agar aap Minimum Order Quantity se kam value quantity mei dalte hai toh <br> &nbsp &nbsp apke final bill mei automatically Minimum Order quantity le li jayegi .<br></b> 
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productImage2']);?>" width="150" height="160" alt=""></a>
			</div><!-- /.image -->			
