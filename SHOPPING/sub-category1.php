...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">s\Shop by</h3>
...
{?>	
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" alt="" width="210" height="300"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<?php
							$shiva ="".$_SERVER['REQUEST_URI'];
							$shiva = substr($shiva,0,39);
							?>
							<a href="<?php echo $shiva ?>page=product&action=add&id=<?php echo $row['id']; ?>">
