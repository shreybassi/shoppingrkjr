...
{?>							
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" alt="" width="200" height="200"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<?php
							$shrey ="".$_SERVER['REQUEST_URI'];
							$shrey = substr($shrey,0,38);
							?>
							<a href="<?php echo $shrey ?>page=product&action=add&id=<?php echo $row['id']; ?>">
