...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	...
	<button onclick="location.href='supplierbest.php'">Back to Supplier</button>
	<br>
				<script type="text/javascript" src="dist/jquery.tableditbest.js"></script>
<div class="container home">	
	<table id="data_table" class="table table-striped">
		...
		<tbody>
			<?php 
			$supplier = $_POST['sup'];
			$sql_query = "SELECT icode, iname, sup, wkhan, rkhan, unit FROM stockbest where sup='$supplier'";
...
<script type="text/javascript" src="custom_table_editbest.js"></script>
