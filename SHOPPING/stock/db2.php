	...
	<body>
		...
		<div id="block">
			...
			<div id="main-area">
				...
				<div id="mini_nav">
					<div id="mini_board">
						<div class = "mini_font"><a href="supplier.php">A-BLOCK ITC</a></div>
						<img src="img/A1.png"/>
					</div>
					
					<div id="mini_board">
						<div class = "mini_font"><a href="supplier.php">A-BLOCK HRM</a></div>
						<img src="img/A2.png"/>
					</div>
					
					<div id="mini_board">
						<div class = "mini_font"><a href="supplier.php">B-BLOCK</a></div>
						<img src="img/B.png" />
					</div>
					
					<div id="mini_board">
						<div class = "mini_font"><a href="supplier.php">C-BLOCK</a></div>
						<img src="img/C.png"/>
					</div>
