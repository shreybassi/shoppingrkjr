...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	...
	<button onclick="location.href='suppliershop.php'">Back to Supplier</button>
	<br>
				<script type="text/javascript" src="dist/jquery.tableditshop.js"></script>
<div class="container home">	
	<table id="data_table" class="table table-striped">
		...
		<tbody>
			<?php 
			$supplier = $_POST['sup'];
			$sql_query = "SELECT icode, iname, sup, wkhan, rkhan, unit FROM stockshop where sup='$supplier'";
...
<script type="text/javascript" src="custom_table_editshop.js"></script>
