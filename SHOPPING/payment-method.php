...
$userrow = mysqli_fetch_array($userdata);
		...
		$Subject = "RKJR WHOLESALE- You have a new order from ".	$userrow['lcode'];
		...
		Hi Admin, <br><br>
		  ...
		  <body bgcolor=\"WhiteSmoke\"> <br>
			<left> 
					...
					Customer Phone : ".$userrow['phone']."<br>
					Customer Lcode : ".$userrow['lcode']."
			</left> 
			  <br><br><br><br><br><br>** This is an auto generated mail, don't respond to this mail. <br><br>___________________<br> Regards<br>RKJR Shopping Admin Team. 
		  </body> 
		</html>"; 
		$Type = "HTML";
